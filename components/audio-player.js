  ...
  class AudioPlayer extends HTMLElement {
    ...
    updateFrequency() {
      ...
      for (let i = 0; i < barCount; i++) {
        ...
        this.canvasCtx.fillStyle = `coral`;
      ...
      <style>
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 30px;
            height: 30px;
            background: url("../src/audio-player-icon-sprite.png") 0 center/500% 100% no-repeat;
            appearance: none;
            border: none;
        ...
        .play-btn.playing {
            background: url("../src/audio-player-icon-sprite.png") 25% center/500% 100% no-repeat;
        }
        ...
        .volume-bar {
            ...
            min-width: 30px;
            height: 30px;
            background: url("../src/audio-player-icon-sprite.png") 50% center/500% 100% no-repeat;
            position: relative;
        }
        
        .volume-bar.half {
            background: url("../src/audio-player-icon-sprite.png") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("../src/audio-player-icon-sprite.png") 100% center/500% 100% no-repeat;
        }
        ...
        .volume-field {
          ...
          right: 150%;
          top: 65%;
          transform: translateY(27%) rotate(
      -360deg
      );
          z-index: 5;
          margin: -10px;
    ...
    render() {
      this.shadowRoot.innerHTML = `
       ${this.style()}
        <figure class="audio-player" style="margin-top:30px;">
