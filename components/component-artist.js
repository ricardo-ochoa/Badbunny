...
class componentArtist extends HTMLElement {
    ...
    static get observedAttributes() {
      return ["artistnumber", "tracksfeaturings", "nickname", "artistname", "img"];
    }
    attributeChangedCallback(attr, oldVal, newVal) {
      if (attr === "artistnumber") {
        this.artistnumber = newVal;
      }
    ...
    getTemplate() {
      ...
      template.innerHTML = `
        <div class="${this.img} artist " id="artist">

          <div class="number-tracks">
          <p>${this.artistnumber}</p> <p>${this.tracksfeaturings}</p>
          </div>
